...
//import { connectToSolana } from "@components/layout/send";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Everything you need i have"
        />
      </Head>
      <DrawerContainer>
        <PageContainer>
      ...
      <Modal
        ...
        headerContent="Send some $NFTs to someone you love"
        buttonContent="Send $NFT"
